...
public class HeadNewsEditorChoiceAdapter extends FragmentStateAdapter {

    private final ArrayList<News> sliderNews;
    private final int[] newsIdList;


    public HeadNewsEditorChoiceAdapter(@NonNull FragmentManager fragmentManager, @NonNull Lifecycle lifecycle, NewsList newsList) {
        super(fragmentManager, lifecycle);
        this.sliderNews = newsList.editorsChoice;
